# Claude Design Prompt - Arcee AI Trinity Large

Metadata from source inventory:
- Model: Arcee AI Trinity Large
- Year: 2026
- Release date: 2026-01-27
- Lab: Arcee AI / Prime Intellect
- Size / active size: unspecified in report
- License / openness: Apache-2.0
- Architecture / modality note: Sparse MoE Transformer; gated GQA; local-global attention.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Arcee+AI+Trinity+Large
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Arcee AI Trinity Large.

Primary source leads to use:
- Hugging Face lookup for Arcee AI Trinity Large: https://huggingface.co/models?search=Arcee+AI+Trinity+Large
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Arcee AI Trinity Large" "model card"
- "Arcee AI Trinity Large" "technical report"
- "Arcee AI Trinity Large" "architecture" "config"
- "Arcee AI Trinity Large" "benchmark" "Arcee AI / Prime Intellect"

Primary-source checklist for this model:
- Official model card or repository from Arcee AI / Prime Intellect.
- Official technical report, paper, release blog, or documentation page for Arcee AI Trinity Large.
...
- Model: Arcee AI Trinity Large
- Family/vendor or lab: Arcee AI / Prime Intellect
- Release/report date: 2026-01-27
- Release year: 2026
...
- Target page title: "Arcee AI Trinity Large Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse MoE Transformer; gated GQA; local-global attention.
- Attention mechanism lead: GQA; local-global attention
...
Goal:
Build a visual architecture atlas page that explains Arcee AI Trinity Large from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Arcee AI Trinity Large. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; gated GQA; local-global attention.
...
3. Attention and sequence handling:
   - Explain the verified attention variant. Inventory lead: GQA; local-global attention.
...
- The first viewport should immediately identify Arcee AI Trinity Large and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Arcee AI Trinity Large when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Arcee AI Trinity Large.
```
