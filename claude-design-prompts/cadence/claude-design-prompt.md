# Claude Design Prompt - Cadence

Metadata from source inventory:
- Model: Cadence
- Year: 2025
- Release date: mid-2025
- Lab: AI4Bharat / IIT Madras
- Size / active size: Gemma-3-1B based
- License / openness: MIT
- Architecture / modality note: Multilingual punctuation-restoration model for English plus 22 Indic languages.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=AI4Bharat+Cadence
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Cadence.

Primary source leads to use:
- Hugging Face lookup for Cadence: https://huggingface.co/models?search=AI4Bharat+Cadence
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Cadence" "architecture" "config"
- "Cadence" "benchmark" "AI4Bharat / IIT Madras"

Primary-source checklist for this model:
- Official model card or repository from AI4Bharat / IIT Madras.
- Official technical report, paper, release blog, or documentation page for Cadence.
...
- Model: Cadence
- Family/vendor or lab: AI4Bharat / IIT Madras
- Release/report date: mid-2025
- Release year: 2025
- Parameter scale: Gemma-3-1B based
- Active parameter scale: unknown in source inventory
- License or openness: MIT
- Inventory source strength: Deep table
- Target page title: "Cadence Architecture"
...
Goal:
Build a visual architecture atlas page that explains Cadence from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Cadence. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Multilingual punctuation-restoration model for English plus 22 Indic languages.
...
5. Model-specific sections to create from the inventory leads:
   - Multilingual punctuation-restoration model for English plus 22 Indic languages
...
- The first viewport should immediately identify Cadence and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Cadence when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Cadence.
```
