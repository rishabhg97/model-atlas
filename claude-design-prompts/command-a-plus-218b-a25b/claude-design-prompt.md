# Claude Design Prompt - Command A+ 218B-A25B

Metadata from source inventory:
- Model: Command A+ 218B-A25B
- Year: 2026
- Release date: 2026-05-20
- Lab: Cohere
- Size / active size: 218B total / 25B active
- License / openness: Apache-2.0
- Architecture / modality note: Sparse MoE Transformer; parallel attention and MoE; decoder-only.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Command+A%2B+218B-A25B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Command A+ 218B-A25B.

Primary source leads to use:
- Hugging Face lookup for Command A+ 218B-A25B: https://huggingface.co/models?search=Command+A%2B+218B-A25B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Command A+ 218B-A25B" "model card"
- "Command A+ 218B-A25B" "technical report"
- "Command A+ 218B-A25B" "architecture" "config"
- "Command A+ 218B-A25B" "benchmark" "Cohere"

Primary-source checklist for this model:
- Official model card or repository from Cohere.
- Official technical report, paper, release blog, or documentation page for Command A+ 218B-A25B.
...
- Release/report date: 2026-05-20
- Release year: 2026
- Parameter scale: 218B total
- Active parameter scale: 25B active
- License or openness: Apache-2.0
- Inventory source strength: Raschka table
- Target page title: "Command A+ 218B-A25B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Command A+ 218B-A25B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Command A+ 218B-A25B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; parallel attention and MoE; decoder-only.
...
- The first viewport should immediately identify Command A+ 218B-A25B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Command A+ 218B-A25B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Command A+ 218B-A25B.
```
