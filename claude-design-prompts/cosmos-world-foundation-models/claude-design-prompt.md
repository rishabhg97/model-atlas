# Claude Design Prompt - Cosmos World Foundation Models

Metadata from source inventory:
- Model: Cosmos World Foundation Models
- Year: 2025
- Release date: 2025-01
- Lab: NVIDIA
- Size / active size: family, sizes unspecified in report
- License / openness: open-weight / project assets noted
- Architecture / modality note: Video/world foundation models for physical AI; video tokenizers and world generation/understanding.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=Cosmos+World+Foundation+Models
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Cosmos World Foundation Models.

Primary source leads to use:
- Hugging Face lookup for Cosmos World Foundation Models: https://huggingface.co/models?search=Cosmos+World+Foundation+Models
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Cosmos World Foundation Models" "model card"
- "Cosmos World Foundation Models" "technical report"
- "Cosmos World Foundation Models" "architecture" "config"
- "Cosmos World Foundation Models" "benchmark" "NVIDIA"

Primary-source checklist for this model:
- Official model card or repository from NVIDIA.
- Official technical report, paper, release blog, or documentation page for Cosmos World Foundation Models.
...
- Release/report date: 2025-01
- Release year: 2025
- Parameter scale: family, sizes unspecified in report
- Active parameter scale: unknown in source inventory
- License or openness: open-weight / project assets noted
- Inventory source strength: Deep table
- Target page title: "Cosmos World Foundation Models Architecture"
...
Goal:
Build a visual architecture atlas page that explains Cosmos World Foundation Models from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Cosmos World Foundation Models. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Video/world foundation models for physical AI; video tokenizers and world generation/understanding.
...
5. Model-specific sections to create from the inventory leads:
   - Video/world foundation models for physical AI
   - video tokenizers and world generation/understanding
...
- The first viewport should immediately identify Cosmos World Foundation Models and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Cosmos World Foundation Models when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Cosmos World Foundation Models.
```
