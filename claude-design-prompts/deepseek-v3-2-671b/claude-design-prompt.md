# Claude Design Prompt - DeepSeek V3.2 671B
...
- Source lead: https://huggingface.co/models?search=DeepSeek+V3.2+671B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for DeepSeek V3.2 671B.

Primary source leads to use:
- Hugging Face lookup for DeepSeek V3.2 671B: https://huggingface.co/models?search=DeepSeek+V3.2+671B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "DeepSeek V3.2 671B" "model card"
- "DeepSeek V3.2 671B" "technical report"
- "DeepSeek V3.2 671B" "architecture" "config"
- "DeepSeek V3.2 671B" "benchmark" "DeepSeek"

Primary-source checklist for this model:
- Official model card or repository from DeepSeek.
- Official technical report, paper, release blog, or documentation page for DeepSeek V3.2 671B.
...
Goal:
Build a visual architecture atlas page that explains DeepSeek V3.2 671B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to DeepSeek V3.2 671B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify DeepSeek V3.2 671B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for DeepSeek V3.2 671B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for DeepSeek V3.2 671B.
```
