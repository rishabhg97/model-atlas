# Claude Design Prompt - DeepSeek V4-Pro 1.6T
...
- Source lead: https://huggingface.co/models?search=DeepSeek+V4-Pro+1.6T
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for DeepSeek V4-Pro 1.6T.

Primary source leads to use:
- Hugging Face lookup for DeepSeek V4-Pro 1.6T: https://huggingface.co/models?search=DeepSeek+V4-Pro+1.6T
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "DeepSeek V4-Pro 1.6T" "model card"
- "DeepSeek V4-Pro 1.6T" "technical report"
- "DeepSeek V4-Pro 1.6T" "architecture" "config"
- "DeepSeek V4-Pro 1.6T" "benchmark" "DeepSeek"

Primary-source checklist for this model:
- Official model card or repository from DeepSeek.
- Official technical report, paper, release blog, or documentation page for DeepSeek V4-Pro 1.6T.
...
Goal:
Build a visual architecture atlas page that explains DeepSeek V4-Pro 1.6T from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to DeepSeek V4-Pro 1.6T. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify DeepSeek V4-Pro 1.6T and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for DeepSeek V4-Pro 1.6T when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for DeepSeek V4-Pro 1.6T.
```
