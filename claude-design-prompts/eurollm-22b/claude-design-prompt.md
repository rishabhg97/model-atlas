# Claude Design Prompt - EuroLLM-22B

Metadata from source inventory:
- Model: EuroLLM-22B
- Year: 2026
- Release date: 2026-02
- Lab: EuroLLM consortium
- Size / active size: 22B
- License / openness: open artifacts noted
- Architecture / modality note: Multilingual LLM for EU languages; 32K context.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=EuroLLM-22B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for EuroLLM-22B.

Primary source leads to use:
- Hugging Face lookup for EuroLLM-22B: https://huggingface.co/models?search=EuroLLM-22B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "EuroLLM-22B" "model card"
- "EuroLLM-22B" "technical report"
- "EuroLLM-22B" "architecture" "config"
- "EuroLLM-22B" "benchmark" "EuroLLM consortium"

Primary-source checklist for this model:
- Official model card or repository from EuroLLM consortium.
- Official technical report, paper, release blog, or documentation page for EuroLLM-22B.
...
- Model: EuroLLM-22B
- Family/vendor or lab: EuroLLM consortium
- Release/report date: 2026-02
- Release year: 2026
- Parameter scale: 22B
- Active parameter scale: unknown in source inventory
- License or openness: open artifacts noted
- Inventory source strength: Deep table
- Target page title: "EuroLLM-22B Architecture"
...
Goal:
Build a visual architecture atlas page that explains EuroLLM-22B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to EuroLLM-22B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Multilingual LLM for EU languages; 32K context.
...
5. Model-specific sections to create from the inventory leads:
   - Multilingual LLM for EU languages
   - 32K context
...
- The first viewport should immediately identify EuroLLM-22B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for EuroLLM-22B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for EuroLLM-22B.
```
