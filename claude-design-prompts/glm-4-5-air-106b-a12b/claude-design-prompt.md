# Claude Design Prompt - GLM-4.5-Air 106B-A12B

Metadata from source inventory:
- Model: GLM-4.5-Air 106B-A12B
- Year: 2025
- Release date: 2025-07-28
- Lab: Zhipu AI / THUDM
- Size / active size: 106B total / 12B active
- License / openness: MIT
- Architecture / modality note: Sparse MoE Transformer; GQA; QK-Norm; RoPE.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=GLM-4.5-Air+106B-A12B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for GLM-4.5-Air 106B-A12B.

Primary source leads to use:
- Hugging Face lookup for GLM-4.5-Air 106B-A12B: https://huggingface.co/models?search=GLM-4.5-Air+106B-A12B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "GLM-4.5-Air 106B-A12B" "model card"
- "GLM-4.5-Air 106B-A12B" "technical report"
- "GLM-4.5-Air 106B-A12B" "architecture" "config"
- "GLM-4.5-Air 106B-A12B" "benchmark" "Zhipu AI / THUDM"

Primary-source checklist for this model:
- Official model card or repository from Zhipu AI / THUDM.
- Official technical report, paper, release blog, or documentation page for GLM-4.5-Air 106B-A12B.
...
- Release/report date: 2025-07-28
- Release year: 2025
- Parameter scale: 106B total
- Active parameter scale: 12B active
- License or openness: MIT
- Inventory source strength: Raschka table
- Target page title: "GLM-4.5-Air 106B-A12B Architecture"
...
Goal:
Build a visual architecture atlas page that explains GLM-4.5-Air 106B-A12B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to GLM-4.5-Air 106B-A12B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; GQA; QK-Norm; RoPE.
...
- The first viewport should immediately identify GLM-4.5-Air 106B-A12B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for GLM-4.5-Air 106B-A12B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for GLM-4.5-Air 106B-A12B.
```
