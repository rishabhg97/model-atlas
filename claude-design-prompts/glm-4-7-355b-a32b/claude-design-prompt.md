# Claude Design Prompt - GLM-4.7 355B-A32B

Metadata from source inventory:
- Model: GLM-4.7 355B-A32B
- Year: 2025
...
- Source lead: https://huggingface.co/models?search=GLM-4.7+355B-A32B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for GLM-4.7 355B-A32B.

Primary source leads to use:
- Hugging Face lookup for GLM-4.7 355B-A32B: https://huggingface.co/models?search=GLM-4.7+355B-A32B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "GLM-4.7 355B-A32B" "model card"
- "GLM-4.7 355B-A32B" "technical report"
- "GLM-4.7 355B-A32B" "architecture" "config"
- "GLM-4.7 355B-A32B" "benchmark" "Zhipu AI / THUDM"

Primary-source checklist for this model:
- Official model card or repository from Zhipu AI / THUDM.
- Official technical report, paper, release blog, or documentation page for GLM-4.7 355B-A32B.
...
- Release/report date: 2025-12-22
- Release year: 2025
...
- Target page title: "GLM-4.7 355B-A32B Architecture"
...
Goal:
Build a visual architecture atlas page that explains GLM-4.7 355B-A32B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to GLM-4.7 355B-A32B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify GLM-4.7 355B-A32B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for GLM-4.7 355B-A32B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for GLM-4.7 355B-A32B.
```
