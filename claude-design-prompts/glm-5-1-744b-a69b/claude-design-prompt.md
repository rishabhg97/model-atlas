# Claude Design Prompt - GLM-5.1 744B-A69B

Metadata from source inventory:
- Model: GLM-5.1 744B-A69B
- Year: 2026
- Release date: 2026-04-07
- Lab: Zhipu AI / THUDM
- Size / active size: 744B total / 69B active
- License / openness: MIT
- Architecture / modality note: Sparse MoE Transformer; MLA plus DSA; MTP; decoder-only.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=GLM-5.1+744B-A69B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for GLM-5.1 744B-A69B.

Primary source leads to use:
- Hugging Face lookup for GLM-5.1 744B-A69B: https://huggingface.co/models?search=GLM-5.1+744B-A69B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "GLM-5.1 744B-A69B" "model card"
- "GLM-5.1 744B-A69B" "technical report"
- "GLM-5.1 744B-A69B" "architecture" "config"
- "GLM-5.1 744B-A69B" "benchmark" "Zhipu AI / THUDM"

Primary-source checklist for this model:
- Official model card or repository from Zhipu AI / THUDM.
- Official technical report, paper, release blog, or documentation page for GLM-5.1 744B-A69B.
...
- Model: GLM-5.1 744B-A69B
- Family/vendor or lab: Zhipu AI / THUDM
- Release/report date: 2026-04-07
- Release year: 2026
- Parameter scale: 744B total
- Active parameter scale: 69B active
- License or openness: MIT
- Inventory source strength: Raschka table
- Target page title: "GLM-5.1 744B-A69B Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse MoE Transformer; MLA plus DSA; MTP; decoder-only.
- Attention mechanism lead: MLA; DSA
...
Goal:
Build a visual architecture atlas page that explains GLM-5.1 744B-A69B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to GLM-5.1 744B-A69B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; MLA plus DSA; MTP; decoder-only.
...
3. Attention and sequence handling:
   - Explain the verified attention variant. Inventory lead: MLA; DSA.
...
- The first viewport should immediately identify GLM-5.1 744B-A69B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for GLM-5.1 744B-A69B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for GLM-5.1 744B-A69B.
```
