# Claude Design Prompt - GLM-5 744B-A69B

Metadata from source inventory:
- Model: GLM-5 744B-A69B
- Year: 2026
...
- Source lead: https://huggingface.co/models?search=GLM-5+744B-A69B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for GLM-5 744B-A69B.

Primary source leads to use:
- Hugging Face lookup for GLM-5 744B-A69B: https://huggingface.co/models?search=GLM-5+744B-A69B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "GLM-5 744B-A69B" "model card"
- "GLM-5 744B-A69B" "technical report"
- "GLM-5 744B-A69B" "architecture" "config"
- "GLM-5 744B-A69B" "benchmark" "Zhipu AI / THUDM"

Primary-source checklist for this model:
- Official model card or repository from Zhipu AI / THUDM.
- Official technical report, paper, release blog, or documentation page for GLM-5 744B-A69B.
...
- Release/report date: 2026-02-11
- Release year: 2026
...
- Target page title: "GLM-5 744B-A69B Architecture"
...
Goal:
Build a visual architecture atlas page that explains GLM-5 744B-A69B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to GLM-5 744B-A69B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify GLM-5 744B-A69B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for GLM-5 744B-A69B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for GLM-5 744B-A69B.
```
