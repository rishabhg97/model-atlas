# Claude Design Prompt - Granite 4.1 30B
...
- Source lead: https://huggingface.co/models?search=Granite+4.1+30B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Granite 4.1 30B.

Primary source leads to use:
- Hugging Face lookup for Granite 4.1 30B: https://huggingface.co/models?search=Granite+4.1+30B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Granite 4.1 30B" "model card"
- "Granite 4.1 30B" "technical report"
- "Granite 4.1 30B" "architecture" "config"
- "Granite 4.1 30B" "benchmark" "IBM"

Primary-source checklist for this model:
- Official model card or repository from IBM.
- Official technical report, paper, release blog, or documentation page for Granite 4.1 30B.
...
Goal:
Build a visual architecture atlas page that explains Granite 4.1 30B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Granite 4.1 30B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Granite 4.1 30B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Granite 4.1 30B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Granite 4.1 30B.
```
