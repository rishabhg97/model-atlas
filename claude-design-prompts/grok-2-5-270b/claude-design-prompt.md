# Claude Design Prompt - Grok 2.5 270B
...
- Lab: xAI
- Size / active size: 270B
- License / openness: Grok 2 Community License
- Architecture / modality note: Sparse MoE Transformer; GQA; RoPE; decoder-only.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Grok+2.5+270B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Grok 2.5 270B.

Primary source leads to use:
- Hugging Face lookup for Grok 2.5 270B: https://huggingface.co/models?search=Grok+2.5+270B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Grok 2.5 270B" "model card"
- "Grok 2.5 270B" "technical report"
- "Grok 2.5 270B" "architecture" "config"
- "Grok 2.5 270B" "benchmark" "xAI"

Primary-source checklist for this model:
- Official model card or repository from xAI.
- Official technical report, paper, release blog, or documentation page for Grok 2.5 270B.
...
- Model: Grok 2.5 270B
- Family/vendor or lab: xAI
- Release/report date: 2025-08-22
- Release year: 2025
- Parameter scale: 270B
- Active parameter scale: unknown in source inventory
- License or openness: Grok 2 Community License
- Inventory source strength: Raschka table
- Target page title: "Grok 2.5 270B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Grok 2.5 270B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Grok 2.5 270B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Grok 2.5 270B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Grok 2.5 270B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Grok 2.5 270B.
```
