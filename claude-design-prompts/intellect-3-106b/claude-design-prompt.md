# Claude Design Prompt - INTELLECT-3 106B

Metadata from source inventory:
- Model: INTELLECT-3 106B
- Year: 2025
- Release date: 2025-11-26
- Lab: Prime Intellect
- Size / active size: 106B
- License / openness: MIT
- Architecture / modality note: Sparse MoE Transformer; GLM-4.5-Air-derived architecture.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=INTELLECT-3+106B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for INTELLECT-3 106B.

Primary source leads to use:
- Hugging Face lookup for INTELLECT-3 106B: https://huggingface.co/models?search=INTELLECT-3+106B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "INTELLECT-3 106B" "model card"
- "INTELLECT-3 106B" "technical report"
- "INTELLECT-3 106B" "architecture" "config"
- "INTELLECT-3 106B" "benchmark" "Prime Intellect"

Primary-source checklist for this model:
- Official model card or repository from Prime Intellect.
- Official technical report, paper, release blog, or documentation page for INTELLECT-3 106B.
...
- Model: INTELLECT-3 106B
- Family/vendor or lab: Prime Intellect
- Release/report date: 2025-11-26
- Release year: 2025
- Parameter scale: 106B
- Active parameter scale: unknown in source inventory
- License or openness: MIT
- Inventory source strength: Raschka table
- Target page title: "INTELLECT-3 106B Architecture"
...
Goal:
Build a visual architecture atlas page that explains INTELLECT-3 106B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to INTELLECT-3 106B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; GLM-4.5-Air-derived architecture.
...
5. Model-specific sections to create from the inventory leads:
   ...
   - GLM-4.5-Air-derived architecture
...
- The first viewport should immediately identify INTELLECT-3 106B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for INTELLECT-3 106B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for INTELLECT-3 106B.
```
