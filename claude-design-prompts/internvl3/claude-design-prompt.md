# Claude Design Prompt - InternVL3

Metadata from source inventory:
- Model: InternVL3
- Year: 2025
- Release date: 2025-04
- Lab: OpenGVLab / Shanghai AI Lab partners
- Size / active size: roughly 1B to 78B family
- License / openness: public weights noted
- Architecture / modality note: Native multimodal pretraining family; perception/reasoning MLLM.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=InternVL3
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for InternVL3.

Primary source leads to use:
- Hugging Face lookup for InternVL3: https://huggingface.co/models?search=InternVL3
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "InternVL3" "model card"
- "InternVL3" "technical report"
- "InternVL3" "architecture" "config"
- "InternVL3" "benchmark" "OpenGVLab / Shanghai AI Lab partners"

Primary-source checklist for this model:
- Official model card or repository from OpenGVLab / Shanghai AI Lab partners.
- Official technical report, paper, release blog, or documentation page for InternVL3.
...
- Model: InternVL3
- Family/vendor or lab: OpenGVLab / Shanghai AI Lab partners
- Release/report date: 2025-04
- Release year: 2025
- Parameter scale: roughly 1B to 78B family
...
- Target page title: "InternVL3 Architecture"
...
Goal:
Build a visual architecture atlas page that explains InternVL3 from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to InternVL3. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Native multimodal pretraining family; perception/reasoning MLLM.
...
5. Model-specific sections to create from the inventory leads:
   - Native multimodal pretraining family
   - perception/reasoning MLLM
...
- The first viewport should immediately identify InternVL3 and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for InternVL3 when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for InternVL3.
```
