# Claude Design Prompt - Janus-Pro
...
- Architecture / modality note: Multimodal/generative family called out as follow-up candidate.
- Source strength: Deep offhand mention
- Source lead: https://huggingface.co/models?search=Janus-Pro
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Janus-Pro.

Primary source leads to use:
- Hugging Face lookup for Janus-Pro: https://huggingface.co/models?search=Janus-Pro
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Janus-Pro" "model card"
- "Janus-Pro" "technical report"
- "Janus-Pro" "architecture" "config"
- "Janus-Pro" "benchmark" "DeepSeek"

Primary-source checklist for this model:
- Official model card or repository from DeepSeek.
- Official technical report, paper, release blog, or documentation page for Janus-Pro.
...
- Target page title: "Janus-Pro Architecture"
...
Goal:
Build a visual architecture atlas page that explains Janus-Pro from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Janus-Pro. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Multimodal/generative family called out as follow-up candidate.
...
5. Model-specific sections to create from the inventory leads:
   - Multimodal/generative family called out as follow-up candidate
...
- The first viewport should immediately identify Janus-Pro and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Janus-Pro when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Janus-Pro.
```
