# Claude Design Prompt - K2-V2

Metadata from source inventory:
- Model: K2-V2
- Year: 2025
- Release date: 2025-12
- Lab: MBZUAI IFM / LLM360
- Size / active size: 70B
- License / openness: Apache-2.0
- Architecture / modality note: Dense Transformer; "360-open" reasoning-enhanced LLM with checkpoints/data/code noted.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=K2-V2+70B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for K2-V2.

Primary source leads to use:
- Hugging Face lookup for K2-V2: https://huggingface.co/models?search=K2-V2+70B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "K2-V2" "model card"
- "K2-V2" "technical report"
- "K2-V2" "architecture" "config"
- "K2-V2" "benchmark" "MBZUAI IFM / LLM360"

Primary-source checklist for this model:
- Official model card or repository from MBZUAI IFM / LLM360.
- Official technical report, paper, release blog, or documentation page for K2-V2.
...
Goal:
Build a visual architecture atlas page that explains K2-V2 from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to K2-V2. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Dense Transformer; "360-open" reasoning-enhanced LLM with checkpoints/data/code noted.
...
5. Model-specific sections to create from the inventory leads:
   - Dense Transformer
   - "360-open" reasoning-enhanced LLM with checkpoints/data/code noted
...
- The first viewport should immediately identify K2-V2 and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for K2-V2 when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for K2-V2.
```
