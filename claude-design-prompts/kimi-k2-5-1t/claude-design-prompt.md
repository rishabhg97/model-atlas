# Claude Design Prompt - Kimi K2.5 1T
...
- Source lead: https://huggingface.co/models?search=Kimi+K2.5+1T
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Kimi K2.5 1T.

Primary source leads to use:
- Hugging Face lookup for Kimi K2.5 1T: https://huggingface.co/models?search=Kimi+K2.5+1T
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Kimi K2.5 1T" "model card"
- "Kimi K2.5 1T" "technical report"
- "Kimi K2.5 1T" "architecture" "config"
- "Kimi K2.5 1T" "benchmark" "Moonshot AI"

Primary-source checklist for this model:
- Official model card or repository from Moonshot AI.
- Official technical report, paper, release blog, or documentation page for Kimi K2.5 1T.
...
- Target page title: "Kimi K2.5 1T Architecture"
...
Goal:
Build a visual architecture atlas page that explains Kimi K2.5 1T from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Kimi K2.5 1T. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Kimi K2.5 1T and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Kimi K2.5 1T when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Kimi K2.5 1T.
```
