# Claude Design Prompt - Kimi Linear 48B-A3B
...
- Lab: Moonshot AI
- Size / active size: 48B total / 3B active
- License / openness: MIT
- Architecture / modality note: Sparse hybrid model; Kimi Delta Attention plus MLA.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Kimi+Linear+48B-A3B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Kimi Linear 48B-A3B.

Primary source leads to use:
- Hugging Face lookup for Kimi Linear 48B-A3B: https://huggingface.co/models?search=Kimi+Linear+48B-A3B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Kimi Linear 48B-A3B" "model card"
- "Kimi Linear 48B-A3B" "technical report"
- "Kimi Linear 48B-A3B" "architecture" "config"
- "Kimi Linear 48B-A3B" "benchmark" "Moonshot AI"

Primary-source checklist for this model:
- Official model card or repository from Moonshot AI.
- Official technical report, paper, release blog, or documentation page for Kimi Linear 48B-A3B.
...
- Release/report date: 2025-10-30
- Release year: 2025
- Parameter scale: 48B total
- Active parameter scale: 3B active
- License or openness: MIT
- Inventory source strength: Raschka table
- Target page title: "Kimi Linear 48B-A3B Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse hybrid model; Kimi Delta Attention plus MLA.
- Attention mechanism lead: MLA; Kimi Delta Attention
...
Goal:
Build a visual architecture atlas page that explains Kimi Linear 48B-A3B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Kimi Linear 48B-A3B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse hybrid model; Kimi Delta Attention plus MLA.
...
3. Attention and sequence handling:
   - Explain the verified attention variant. Inventory lead: MLA; Kimi Delta Attention.
...
- The first viewport should immediately identify Kimi Linear 48B-A3B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Kimi Linear 48B-A3B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Kimi Linear 48B-A3B.
```
