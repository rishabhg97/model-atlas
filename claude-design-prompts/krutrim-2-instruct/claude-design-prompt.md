# Claude Design Prompt - Krutrim-2 Instruct
...
- Lab: Krutrim AI Labs
- Size / active size: 12B
- License / openness: Community license
- Architecture / modality note: Dense Transformer based on Mistral-NeMo architecture; Indic/English conversational LM.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=Krutrim-2+Instruct
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Krutrim-2 Instruct.

Primary source leads to use:
- Hugging Face lookup for Krutrim-2 Instruct: https://huggingface.co/models?search=Krutrim-2+Instruct
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Krutrim-2 Instruct" "model card"
- "Krutrim-2 Instruct" "technical report"
- "Krutrim-2 Instruct" "architecture" "config"
- "Krutrim-2 Instruct" "benchmark" "Krutrim AI Labs"

Primary-source checklist for this model:
- Official model card or repository from Krutrim AI Labs.
- Official technical report, paper, release blog, or documentation page for Krutrim-2 Instruct.
...
- Model: Krutrim-2 Instruct
- Family/vendor or lab: Krutrim AI Labs
- Release/report date: 2025-02
- Release year: 2025
- Parameter scale: 12B
- Active parameter scale: unknown in source inventory
- License or openness: Community license
- Inventory source strength: Deep table
- Target page title: "Krutrim-2 Instruct Architecture"
...
Goal:
Build a visual architecture atlas page that explains Krutrim-2 Instruct from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Krutrim-2 Instruct. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Dense Transformer based on Mistral-NeMo architecture; Indic/English conversational LM.
...
5. Model-specific sections to create from the inventory leads:
   - Dense Transformer based on Mistral-NeMo architecture
   - Indic/English conversational LM
...
- The first viewport should immediately identify Krutrim-2 Instruct and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Krutrim-2 Instruct when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Krutrim-2 Instruct.
```
