# Claude Design Prompt - Laguna XS.2 33B

Metadata from source inventory:
- Model: Laguna XS.2 33B
- Year: 2026
- Release date: 2026-04-28
- Lab: Poolside
- Size / active size: 33B
- License / openness: Apache-2.0
- Architecture / modality note: Sparse MoE Transformer; gated GQA; sliding-window/global attention.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Laguna+XS.2+33B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Laguna XS.2 33B.

Primary source leads to use:
- Hugging Face lookup for Laguna XS.2 33B: https://huggingface.co/models?search=Laguna+XS.2+33B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Laguna XS.2 33B" "model card"
- "Laguna XS.2 33B" "technical report"
- "Laguna XS.2 33B" "architecture" "config"
- "Laguna XS.2 33B" "benchmark" "Poolside"

Primary-source checklist for this model:
- Official model card or repository from Poolside.
- Official technical report, paper, release blog, or documentation page for Laguna XS.2 33B.
...
Goal:
Build a visual architecture atlas page that explains Laguna XS.2 33B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Laguna XS.2 33B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; gated GQA; sliding-window/global attention.
...
- The first viewport should immediately identify Laguna XS.2 33B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Laguna XS.2 33B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Laguna XS.2 33B.
```
