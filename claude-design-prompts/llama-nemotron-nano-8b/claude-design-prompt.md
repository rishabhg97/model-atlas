# Claude Design Prompt - Llama-Nemotron Nano 8B

Metadata from source inventory:
- Model: Llama-Nemotron Nano 8B
- Year: 2025
- Release date: 2025-05
- Lab: NVIDIA
- Size / active size: 8B
- License / openness: NVIDIA Open Model License
- Architecture / modality note: Llama-derived reasoning model; dynamic reasoning toggle.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=Llama-Nemotron+Nano+8B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Llama-Nemotron Nano 8B.

Primary source leads to use:
- Hugging Face lookup for Llama-Nemotron Nano 8B: https://huggingface.co/models?search=Llama-Nemotron+Nano+8B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Llama-Nemotron Nano 8B" "model card"
- "Llama-Nemotron Nano 8B" "technical report"
- "Llama-Nemotron Nano 8B" "architecture" "config"
- "Llama-Nemotron Nano 8B" "benchmark" "NVIDIA"

Primary-source checklist for this model:
- Official model card or repository from NVIDIA.
- Official technical report, paper, release blog, or documentation page for Llama-Nemotron Nano 8B.
...
- Target page title: "Llama-Nemotron Nano 8B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Llama-Nemotron Nano 8B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Llama-Nemotron Nano 8B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Llama-derived reasoning model; dynamic reasoning toggle.
...
- The first viewport should immediately identify Llama-Nemotron Nano 8B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Llama-Nemotron Nano 8B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Llama-Nemotron Nano 8B.
```
