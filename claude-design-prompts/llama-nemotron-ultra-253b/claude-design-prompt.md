# Claude Design Prompt - Llama-Nemotron Ultra 253B
...
- Lab: NVIDIA
- Size / active size: 253B
- License / openness: NVIDIA Open Model License
- Architecture / modality note: Llama-derived reasoning model; largest named Llama-Nemotron variant in report.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=Llama-Nemotron+Ultra+253B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Llama-Nemotron Ultra 253B.

Primary source leads to use:
- Hugging Face lookup for Llama-Nemotron Ultra 253B: https://huggingface.co/models?search=Llama-Nemotron+Ultra+253B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Llama-Nemotron Ultra 253B" "model card"
- "Llama-Nemotron Ultra 253B" "technical report"
- "Llama-Nemotron Ultra 253B" "architecture" "config"
- "Llama-Nemotron Ultra 253B" "benchmark" "NVIDIA"

Primary-source checklist for this model:
- Official model card or repository from NVIDIA.
- Official technical report, paper, release blog, or documentation page for Llama-Nemotron Ultra 253B.
...
- Target page title: "Llama-Nemotron Ultra 253B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Llama-Nemotron Ultra 253B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Llama-Nemotron Ultra 253B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Llama-derived reasoning model; largest named Llama-Nemotron variant in report.
...
5. Model-specific sections to create from the inventory leads:
   - Llama-derived reasoning model
   - largest named Llama-Nemotron variant in report
...
- The first viewport should immediately identify Llama-Nemotron Ultra 253B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Llama-Nemotron Ultra 253B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Llama-Nemotron Ultra 253B.
```
