# Claude Design Prompt - LongCat-Flash-Lite 68.5B-A3B

Metadata from source inventory:
- Model: LongCat-Flash-Lite 68.5B-A3B
- Year: 2026
- Release date: 2026-01-28
- Lab: Meituan
- Size / active size: 68.5B total / 3B active
- License / openness: MIT
- Architecture / modality note: Sparse MoE Transformer; MLA; decoder-only.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=LongCat-Flash-Lite+68.5B-A3B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for LongCat-Flash-Lite 68.5B-A3B.

Primary source leads to use:
- Hugging Face lookup for LongCat-Flash-Lite 68.5B-A3B: https://huggingface.co/models?search=LongCat-Flash-Lite+68.5B-A3B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "LongCat-Flash-Lite 68.5B-A3B" "model card"
- "LongCat-Flash-Lite 68.5B-A3B" "technical report"
- "LongCat-Flash-Lite 68.5B-A3B" "architecture" "config"
- "LongCat-Flash-Lite 68.5B-A3B" "benchmark" "Meituan"

Primary-source checklist for this model:
- Official model card or repository from Meituan.
- Official technical report, paper, release blog, or documentation page for LongCat-Flash-Lite 68.5B-A3B.
...
- Model: LongCat-Flash-Lite 68.5B-A3B
- Family/vendor or lab: Meituan
- Release/report date: 2026-01-28
- Release year: 2026
- Parameter scale: 68.5B total
- Active parameter scale: 3B active
- License or openness: MIT
- Inventory source strength: Raschka table
- Target page title: "LongCat-Flash-Lite 68.5B-A3B Architecture"
...
Goal:
Build a visual architecture atlas page that explains LongCat-Flash-Lite 68.5B-A3B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to LongCat-Flash-Lite 68.5B-A3B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify LongCat-Flash-Lite 68.5B-A3B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for LongCat-Flash-Lite 68.5B-A3B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for LongCat-Flash-Lite 68.5B-A3B.
```
