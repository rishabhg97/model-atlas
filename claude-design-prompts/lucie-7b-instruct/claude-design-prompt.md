# Claude Design Prompt - Lucie-7B-Instruct

Metadata from source inventory:
- Model: Lucie-7B-Instruct
- Year: 2025
- Release date: 2025-01
- Lab: OpenLLM-France / LINAGORA-led community
- Size / active size: 7B
- License / openness: OSI-compliant claim in report
- Architecture / modality note: Instruction-tuned Lucie variant.
- Source strength: Deep table
- Source lead: https://huggingface.co/models?search=Lucie-7B-Instruct
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Lucie-7B-Instruct.

Primary source leads to use:
- Hugging Face lookup for Lucie-7B-Instruct: https://huggingface.co/models?search=Lucie-7B-Instruct
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Lucie-7B-Instruct" "model card"
- "Lucie-7B-Instruct" "technical report"
- "Lucie-7B-Instruct" "architecture" "config"
- "Lucie-7B-Instruct" "benchmark" "OpenLLM-France / LINAGORA-led community"

Primary-source checklist for this model:
- Official model card or repository from OpenLLM-France / LINAGORA-led community.
- Official technical report, paper, release blog, or documentation page for Lucie-7B-Instruct.
...
- Model: Lucie-7B-Instruct
- Family/vendor or lab: OpenLLM-France / LINAGORA-led community
- Release/report date: 2025-01
- Release year: 2025
- Parameter scale: 7B
- Active parameter scale: unknown in source inventory
- License or openness: OSI-compliant claim in report
- Inventory source strength: Deep table
- Target page title: "Lucie-7B-Instruct Architecture"
...
Goal:
Build a visual architecture atlas page that explains Lucie-7B-Instruct from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Lucie-7B-Instruct. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Instruction-tuned Lucie variant.
...
5. Model-specific sections to create from the inventory leads:
   - Instruction-tuned Lucie variant
...
- The first viewport should immediately identify Lucie-7B-Instruct and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Lucie-7B-Instruct when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Lucie-7B-Instruct.
```
