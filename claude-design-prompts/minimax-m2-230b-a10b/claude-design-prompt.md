# Claude Design Prompt - MiniMax M2 230B-A10B

Metadata from source inventory:
- Model: MiniMax M2 230B-A10B
- Year: 2025
...
- Source lead: https://huggingface.co/models?search=MiniMax+M2+230B-A10B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for MiniMax M2 230B-A10B.

Primary source leads to use:
- Hugging Face lookup for MiniMax M2 230B-A10B: https://huggingface.co/models?search=MiniMax+M2+230B-A10B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "MiniMax M2 230B-A10B" "model card"
- "MiniMax M2 230B-A10B" "technical report"
- "MiniMax M2 230B-A10B" "architecture" "config"
- "MiniMax M2 230B-A10B" "benchmark" "MiniMax"

Primary-source checklist for this model:
- Official model card or repository from MiniMax.
- Official technical report, paper, release blog, or documentation page for MiniMax M2 230B-A10B.
...
- Release/report date: 2025-10-23
- Release year: 2025
...
- Target page title: "MiniMax M2 230B-A10B Architecture"
...
Goal:
Build a visual architecture atlas page that explains MiniMax M2 230B-A10B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to MiniMax M2 230B-A10B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify MiniMax M2 230B-A10B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for MiniMax M2 230B-A10B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for MiniMax M2 230B-A10B.
```
