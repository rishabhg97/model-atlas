# Claude Design Prompt - MiniMax M2.7 230B-A10B

Metadata from source inventory:
- Model: MiniMax M2.7 230B-A10B
- Year: 2026
- Release date: 2026-03-18
- Lab: MiniMax
- Size / active size: 230B total / 10B active
- License / openness: Non-commercial
- Architecture / modality note: Sparse MoE Transformer; GQA; QK-Norm; partial RoPE.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=MiniMax+M2.7+230B-A10B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for MiniMax M2.7 230B-A10B.

Primary source leads to use:
- Hugging Face lookup for MiniMax M2.7 230B-A10B: https://huggingface.co/models?search=MiniMax+M2.7+230B-A10B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "MiniMax M2.7 230B-A10B" "model card"
- "MiniMax M2.7 230B-A10B" "technical report"
- "MiniMax M2.7 230B-A10B" "architecture" "config"
- "MiniMax M2.7 230B-A10B" "benchmark" "MiniMax"

Primary-source checklist for this model:
- Official model card or repository from MiniMax.
- Official technical report, paper, release blog, or documentation page for MiniMax M2.7 230B-A10B.
...
- Model: MiniMax M2.7 230B-A10B
- Family/vendor or lab: MiniMax
- Release/report date: 2026-03-18
- Release year: 2026
- Parameter scale: 230B total
- Active parameter scale: 10B active
- License or openness: Non-commercial
- Inventory source strength: Raschka table
- Target page title: "MiniMax M2.7 230B-A10B Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse MoE Transformer; GQA; QK-Norm; partial RoPE.
- Attention mechanism lead: GQA
- Positional encoding lead: RoPE; partial RoPE
...
Goal:
Build a visual architecture atlas page that explains MiniMax M2.7 230B-A10B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to MiniMax M2.7 230B-A10B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; GQA; QK-Norm; partial RoPE.
...
3. Attention and sequence handling:
   ...
   - Explain positional encoding. Inventory lead: RoPE; partial RoPE.
...
- The first viewport should immediately identify MiniMax M2.7 230B-A10B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for MiniMax M2.7 230B-A10B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for MiniMax M2.7 230B-A10B.
```
