# Claude Design Prompt - Mistral Large 3 673B-A41B

Metadata from source inventory:
- Model: Mistral Large 3 673B-A41B
- Year: 2025
- Release date: 2025-12-02
- Lab: Mistral AI
- Size / active size: 673B total / 41B active
...
- Source lead: https://huggingface.co/models?search=Mistral+Large+3+673B-A41B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Mistral Large 3 673B-A41B.

Primary source leads to use:
- Hugging Face lookup for Mistral Large 3 673B-A41B: https://huggingface.co/models?search=Mistral+Large+3+673B-A41B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Mistral Large 3 673B-A41B" "model card"
- "Mistral Large 3 673B-A41B" "technical report"
- "Mistral Large 3 673B-A41B" "architecture" "config"
- "Mistral Large 3 673B-A41B" "benchmark" "Mistral AI"

Primary-source checklist for this model:
- Official model card or repository from Mistral AI.
- Official technical report, paper, release blog, or documentation page for Mistral Large 3 673B-A41B.
...
- Release/report date: 2025-12-02
- Release year: 2025
- Parameter scale: 673B total
- Active parameter scale: 41B active
- License or openness: Apache-2.0
- Inventory source strength: Raschka table
- Target page title: "Mistral Large 3 673B-A41B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Mistral Large 3 673B-A41B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Mistral Large 3 673B-A41B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Mistral Large 3 673B-A41B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Mistral Large 3 673B-A41B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Mistral Large 3 673B-A41B.
```
