# Claude Design Prompt - Mistral Small 4 119B-A4B

Metadata from source inventory:
- Model: Mistral Small 4 119B-A4B
- Year: 2026
- Release date: 2026-03-16
- Lab: Mistral AI
- Size / active size: 119B total / 4B active
...
- Source lead: https://huggingface.co/models?search=Mistral+Small+4+119B-A4B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Mistral Small 4 119B-A4B.

Primary source leads to use:
- Hugging Face lookup for Mistral Small 4 119B-A4B: https://huggingface.co/models?search=Mistral+Small+4+119B-A4B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Mistral Small 4 119B-A4B" "model card"
- "Mistral Small 4 119B-A4B" "technical report"
- "Mistral Small 4 119B-A4B" "architecture" "config"
- "Mistral Small 4 119B-A4B" "benchmark" "Mistral AI"

Primary-source checklist for this model:
- Official model card or repository from Mistral AI.
- Official technical report, paper, release blog, or documentation page for Mistral Small 4 119B-A4B.
...
Goal:
Build a visual architecture atlas page that explains Mistral Small 4 119B-A4B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Mistral Small 4 119B-A4B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Mistral Small 4 119B-A4B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Mistral Small 4 119B-A4B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Mistral Small 4 119B-A4B.
```
