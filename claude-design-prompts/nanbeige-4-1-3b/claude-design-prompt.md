# Claude Design Prompt - Nanbeige 4.1 3B

Metadata from source inventory:
- Model: Nanbeige 4.1 3B
- Year: 2026
- Release date: 2026-02-10
- Lab: Nanbeige / open-source project
- Size / active size: 3B
...
- Source lead: https://huggingface.co/models?search=Nanbeige+4.1+3B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Nanbeige 4.1 3B.

Primary source leads to use:
- Hugging Face lookup for Nanbeige 4.1 3B: https://huggingface.co/models?search=Nanbeige+4.1+3B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Nanbeige 4.1 3B" "model card"
- "Nanbeige 4.1 3B" "technical report"
- "Nanbeige 4.1 3B" "architecture" "config"
- "Nanbeige 4.1 3B" "benchmark" "Nanbeige / open-source project"

Primary-source checklist for this model:
- Official model card or repository from Nanbeige / open-source project.
- Official technical report, paper, release blog, or documentation page for Nanbeige 4.1 3B.
...
- Model: Nanbeige 4.1 3B
- Family/vendor or lab: Nanbeige / open-source project
- Release/report date: 2026-02-10
- Release year: 2026
- Parameter scale: 3B
- Active parameter scale: unknown in source inventory
- License or openness: Apache-2.0
- Inventory source strength: Raschka table
- Target page title: "Nanbeige 4.1 3B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Nanbeige 4.1 3B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Nanbeige 4.1 3B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Nanbeige 4.1 3B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Nanbeige 4.1 3B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Nanbeige 4.1 3B.
```
