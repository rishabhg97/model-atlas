# Claude Design Prompt - Nemotron 3 Nano Omni
...
- Architecture / modality note: Multimodal Nemotron 3 family member; token-reduction noted.
- Source strength: Deep family mention
- Source lead: https://huggingface.co/models?search=Nemotron+3+Nano+Omni
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Nemotron 3 Nano Omni.

Primary source leads to use:
- Hugging Face lookup for Nemotron 3 Nano Omni: https://huggingface.co/models?search=Nemotron+3+Nano+Omni
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Nemotron 3 Nano Omni" "architecture" "config"
- "Nemotron 3 Nano Omni" "benchmark" "NVIDIA"

Primary-source checklist for this model:
- Official model card or repository from NVIDIA.
- Official technical report, paper, release blog, or documentation page for Nemotron 3 Nano Omni.
...
- Inventory source strength: Deep family mention
- Target page title: "Nemotron 3 Nano Omni Architecture"
...
Goal:
Build a visual architecture atlas page that explains Nemotron 3 Nano Omni from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Nemotron 3 Nano Omni. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Multimodal Nemotron 3 family member; token-reduction noted.
...
5. Model-specific sections to create from the inventory leads:
   - Multimodal Nemotron 3 family member
   - token-reduction noted
   - Source verification level: Deep family mention
...
- The first viewport should immediately identify Nemotron 3 Nano Omni and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Nemotron 3 Nano Omni when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Nemotron 3 Nano Omni.
```
