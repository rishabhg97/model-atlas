# Claude Design Prompt - Nemotron 3 Super 120B-A12B
...
- Lab: NVIDIA
- Size / active size: 120B total / 12B active class
- License / openness: NVIDIA Open Model License
- Architecture / modality note: Sparse hybrid model; Mamba-2 plus GQA attention layers; LatentMoE in atlas page.
- Source strength: Both tables
- Source lead: https://huggingface.co/models?search=Nemotron+3+Super+120B-A12B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Nemotron 3 Super 120B-A12B.

Primary source leads to use:
- Hugging Face lookup for Nemotron 3 Super 120B-A12B: https://huggingface.co/models?search=Nemotron+3+Super+120B-A12B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Nemotron 3 Super 120B-A12B" "model card"
- "Nemotron 3 Super 120B-A12B" "technical report"
- "Nemotron 3 Super 120B-A12B" "architecture" "config"
- "Nemotron 3 Super 120B-A12B" "benchmark" "NVIDIA"

Primary-source checklist for this model:
- Official model card or repository from NVIDIA.
- Official technical report, paper, release blog, or documentation page for Nemotron 3 Super 120B-A12B.
...
- Release/report date: 2026-03-11
- Release year: 2026
- Parameter scale: 120B total
- Active parameter scale: 12B active class
- License or openness: NVIDIA Open Model License
- Inventory source strength: Both tables
- Target page title: "Nemotron 3 Super 120B-A12B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Nemotron 3 Super 120B-A12B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Nemotron 3 Super 120B-A12B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse hybrid model; Mamba-2 plus GQA attention layers; LatentMoE in atlas page.
...
5. Model-specific sections to create from the inventory leads:
   - Sparse hybrid model
   - Mamba-2 plus GQA attention layers
   - LatentMoE in atlas page
...
- The first viewport should immediately identify Nemotron 3 Super 120B-A12B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Nemotron 3 Super 120B-A12B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Nemotron 3 Super 120B-A12B.
```
