# Claude Design Prompt - Nemotron 3 Ultra
...
- Architecture / modality note: Mentioned as part of Nemotron 3 family.
- Source strength: Deep family mention
- Source lead: https://huggingface.co/models?search=Nemotron+3+Ultra
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Nemotron 3 Ultra.

Primary source leads to use:
- Hugging Face lookup for Nemotron 3 Ultra: https://huggingface.co/models?search=Nemotron+3+Ultra
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Nemotron 3 Ultra" "architecture" "config"
- "Nemotron 3 Ultra" "benchmark" "NVIDIA"

Primary-source checklist for this model:
- Official model card or repository from NVIDIA.
- Official technical report, paper, release blog, or documentation page for Nemotron 3 Ultra.
...
- Target page title: "Nemotron 3 Ultra Architecture"
...
Goal:
Build a visual architecture atlas page that explains Nemotron 3 Ultra from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Nemotron 3 Ultra. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Mentioned as part of Nemotron 3 family.
...
5. Model-specific sections to create from the inventory leads:
   - Mentioned as part of Nemotron 3 family
...
- The first viewport should immediately identify Nemotron 3 Ultra and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Nemotron 3 Ultra when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Nemotron 3 Ultra.
```
