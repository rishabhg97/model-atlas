# Claude Design Prompt - Qwen2.5-Omni
...
- Release date: 2025
- Lab: Alibaba Qwen
- Size / active size: family, size unspecified in source note
- License / openness: unspecified in report
- Architecture / modality note: Omni/multimodal family called out as follow-up candidate.
- Source strength: Deep offhand mention
- Source lead: https://huggingface.co/models?search=Qwen2.5-Omni
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Qwen2.5-Omni.

Primary source leads to use:
- Hugging Face lookup for Qwen2.5-Omni: https://huggingface.co/models?search=Qwen2.5-Omni
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Qwen2.5-Omni" "model card"
- "Qwen2.5-Omni" "technical report"
- "Qwen2.5-Omni" "architecture" "config"
- "Qwen2.5-Omni" "benchmark" "Alibaba Qwen"

Primary-source checklist for this model:
- Official model card or repository from Alibaba Qwen.
- Official technical report, paper, release blog, or documentation page for Qwen2.5-Omni.
...
- Release year: 2025
- Parameter scale: family, size unspecified in source note
...
- Target page title: "Qwen2.5-Omni Architecture"
...
Goal:
Build a visual architecture atlas page that explains Qwen2.5-Omni from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Qwen2.5-Omni. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Omni/multimodal family called out as follow-up candidate.
...
5. Model-specific sections to create from the inventory leads:
   - Omni/multimodal family called out as follow-up candidate
...
- The first viewport should immediately identify Qwen2.5-Omni and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Qwen2.5-Omni when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Qwen2.5-Omni.
```
