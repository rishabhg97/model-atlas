# Claude Design Prompt - Qwen3.5 397B-A26B

Metadata from source inventory:
- Model: Qwen3.5 397B-A26B
- Year: 2026
- Release date: 2026-02-16
- Lab: Alibaba Qwen
- Size / active size: 397B total / 26B active
- License / openness: Apache-2.0
- Architecture / modality note: Sparse hybrid model; Gated DeltaNet plus Gated Attention.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Qwen3.5+397B-A26B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Qwen3.5 397B-A26B.

Primary source leads to use:
- Hugging Face lookup for Qwen3.5 397B-A26B: https://huggingface.co/models?search=Qwen3.5+397B-A26B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Qwen3.5 397B-A26B" "model card"
- "Qwen3.5 397B-A26B" "technical report"
- "Qwen3.5 397B-A26B" "architecture" "config"
- "Qwen3.5 397B-A26B" "benchmark" "Alibaba Qwen"

Primary-source checklist for this model:
- Official model card or repository from Alibaba Qwen.
- Official technical report, paper, release blog, or documentation page for Qwen3.5 397B-A26B.
...
- Release/report date: 2026-02-16
- Release year: 2026
- Parameter scale: 397B total
- Active parameter scale: 26B active
- License or openness: Apache-2.0
- Inventory source strength: Raschka table
- Target page title: "Qwen3.5 397B-A26B Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse hybrid model; Gated DeltaNet plus Gated Attention.
- Attention mechanism lead: Gated Attention
...
Goal:
Build a visual architecture atlas page that explains Qwen3.5 397B-A26B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Qwen3.5 397B-A26B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse hybrid model; Gated DeltaNet plus Gated Attention.
...
3. Attention and sequence handling:
   - Explain the verified attention variant. Inventory lead: Gated Attention.
...
5. Model-specific sections to create from the inventory leads:
   - Sparse hybrid model
   - Gated DeltaNet plus Gated Attention
...
- The first viewport should immediately identify Qwen3.5 397B-A26B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Qwen3.5 397B-A26B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Qwen3.5 397B-A26B.
```
