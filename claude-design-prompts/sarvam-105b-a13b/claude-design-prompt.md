# Claude Design Prompt - Sarvam 105B-A13B

Metadata from source inventory:
- Model: Sarvam 105B-A13B
- Year: 2026
- Release date: 2026-03-03
- Lab: Sarvam AI
- Size / active size: 105B total / 13B active
- License / openness: Apache-2.0
- Architecture / modality note: Sparse MoE Transformer; MLA; KV LayerNorm; NoPE/RoPE.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Sarvam+105B-A13B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Sarvam 105B-A13B.

Primary source leads to use:
- Hugging Face lookup for Sarvam 105B-A13B: https://huggingface.co/models?search=Sarvam+105B-A13B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Sarvam 105B-A13B" "model card"
- "Sarvam 105B-A13B" "technical report"
- "Sarvam 105B-A13B" "architecture" "config"
- "Sarvam 105B-A13B" "benchmark" "Sarvam AI"

Primary-source checklist for this model:
- Official model card or repository from Sarvam AI.
- Official technical report, paper, release blog, or documentation page for Sarvam 105B-A13B.
...
- Model: Sarvam 105B-A13B
- Family/vendor or lab: Sarvam AI
- Release/report date: 2026-03-03
- Release year: 2026
- Parameter scale: 105B total
- Active parameter scale: 13B active
- License or openness: Apache-2.0
- Inventory source strength: Raschka table
- Target page title: "Sarvam 105B-A13B Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse MoE Transformer; MLA; KV LayerNorm; NoPE/RoPE.
- Attention mechanism lead: MLA
- Positional encoding lead: RoPE; NoPE
...
Goal:
Build a visual architecture atlas page that explains Sarvam 105B-A13B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Sarvam 105B-A13B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; MLA; KV LayerNorm; NoPE/RoPE.
...
3. Attention and sequence handling:
   ...
   - Explain positional encoding. Inventory lead: RoPE; NoPE.
...
- The first viewport should immediately identify Sarvam 105B-A13B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Sarvam 105B-A13B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Sarvam 105B-A13B.
```
