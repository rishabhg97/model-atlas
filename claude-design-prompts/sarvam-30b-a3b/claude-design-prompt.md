# Claude Design Prompt - Sarvam 30B-A3B

Metadata from source inventory:
- Model: Sarvam 30B-A3B
- Year: 2026
- Release date: 2026-03-03
- Lab: Sarvam AI
- Size / active size: 30B total / 3B active
- License / openness: Apache-2.0
- Architecture / modality note: Sparse MoE Transformer; GQA; QK-Norm; decoder-only.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Sarvam+30B-A3B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Sarvam 30B-A3B.

Primary source leads to use:
- Hugging Face lookup for Sarvam 30B-A3B: https://huggingface.co/models?search=Sarvam+30B-A3B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Sarvam 30B-A3B" "model card"
- "Sarvam 30B-A3B" "technical report"
- "Sarvam 30B-A3B" "architecture" "config"
- "Sarvam 30B-A3B" "benchmark" "Sarvam AI"

Primary-source checklist for this model:
- Official model card or repository from Sarvam AI.
- Official technical report, paper, release blog, or documentation page for Sarvam 30B-A3B.
...
- Target page title: "Sarvam 30B-A3B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Sarvam 30B-A3B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Sarvam 30B-A3B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; GQA; QK-Norm; decoder-only.
...
- The first viewport should immediately identify Sarvam 30B-A3B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Sarvam 30B-A3B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Sarvam 30B-A3B.
```
