# Claude Design Prompt - Step 3.5 Flash 196B-A20B

Metadata from source inventory:
- Model: Step 3.5 Flash 196B-A20B
- Year: 2026
- Release date: 2026-02-01
- Lab: StepFun
- Size / active size: 196B total / 20B active
- License / openness: Apache-2.0
- Architecture / modality note: Sparse MoE Transformer; GQA; sliding-window/global attention.
- Source strength: Raschka + offhand family cue
- Source lead: https://huggingface.co/models?search=Step+3.5+Flash+196B-A20B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Step 3.5 Flash 196B-A20B.

Primary source leads to use:
- Hugging Face lookup for Step 3.5 Flash 196B-A20B: https://huggingface.co/models?search=Step+3.5+Flash+196B-A20B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Step 3.5 Flash 196B-A20B" "model card"
- "Step 3.5 Flash 196B-A20B" "technical report"
- "Step 3.5 Flash 196B-A20B" "architecture" "config"
- "Step 3.5 Flash 196B-A20B" "benchmark" "StepFun"

Primary-source checklist for this model:
- Official model card or repository from StepFun.
- Official technical report, paper, release blog, or documentation page for Step 3.5 Flash 196B-A20B.
...
- Model: Step 3.5 Flash 196B-A20B
- Family/vendor or lab: StepFun
- Release/report date: 2026-02-01
- Release year: 2026
- Parameter scale: 196B total
- Active parameter scale: 20B active
- License or openness: Apache-2.0
- Inventory source strength: Raschka + offhand family cue
- Target page title: "Step 3.5 Flash 196B-A20B Architecture"

Known architecture and modality facts from the inventory:
- Architecture / modality note: Sparse MoE Transformer; GQA; sliding-window/global attention.
- Attention mechanism lead: GQA; sliding-window/global attention
...
Goal:
Build a visual architecture atlas page that explains Step 3.5 Flash 196B-A20B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Step 3.5 Flash 196B-A20B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse MoE Transformer; GQA; sliding-window/global attention.
...
3. Attention and sequence handling:
   - Explain the verified attention variant. Inventory lead: GQA; sliding-window/global attention.
...
5. Model-specific sections to create from the inventory leads:
   ...
   - Source verification level: Raschka + offhand family cue
...
- The first viewport should immediately identify Step 3.5 Flash 196B-A20B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Step 3.5 Flash 196B-A20B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Step 3.5 Flash 196B-A20B.
```
