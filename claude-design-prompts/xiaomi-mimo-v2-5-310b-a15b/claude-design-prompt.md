# Claude Design Prompt - Xiaomi MiMo-V2.5 310B-A15B

Metadata from source inventory:
- Model: Xiaomi MiMo-V2.5 310B-A15B
- Year: 2026
- Release date: 2026-04-22
- Lab: Xiaomi
- Size / active size: 310B total / 15B active
- License / openness: MIT
- Architecture / modality note: Sparse omnimodal MoE Transformer; GQA and sliding window.
- Source strength: Raschka table
- Source lead: https://huggingface.co/models?search=Xiaomi+MiMo-V2.5+310B-A15B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Xiaomi MiMo-V2.5 310B-A15B.

Primary source leads to use:
- Hugging Face lookup for Xiaomi MiMo-V2.5 310B-A15B: https://huggingface.co/models?search=Xiaomi+MiMo-V2.5+310B-A15B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Xiaomi MiMo-V2.5 310B-A15B" "model card"
- "Xiaomi MiMo-V2.5 310B-A15B" "technical report"
- "Xiaomi MiMo-V2.5 310B-A15B" "architecture" "config"
- "Xiaomi MiMo-V2.5 310B-A15B" "benchmark" "Xiaomi"

Primary-source checklist for this model:
- Official model card or repository from Xiaomi.
- Official technical report, paper, release blog, or documentation page for Xiaomi MiMo-V2.5 310B-A15B.
...
Goal:
Build a visual architecture atlas page that explains Xiaomi MiMo-V2.5 310B-A15B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Xiaomi MiMo-V2.5 310B-A15B. Do not make a generic transformer explainer.
...
2. Block internals:
   - Draw the block structure implied by verified sources and the inventory note: Sparse omnimodal MoE Transformer; GQA and sliding window.
...
3. Attention and sequence handling:
   - Explain the verified attention variant. Inventory lead: GQA; sliding window.
...
5. Model-specific sections to create from the inventory leads:
   - Sparse omnimodal MoE Transformer
   - GQA and sliding window
...
- The first viewport should immediately identify Xiaomi MiMo-V2.5 310B-A15B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Xiaomi MiMo-V2.5 310B-A15B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Xiaomi MiMo-V2.5 310B-A15B.
```
