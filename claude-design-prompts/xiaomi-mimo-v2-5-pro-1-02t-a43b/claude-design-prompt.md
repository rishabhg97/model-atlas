# Claude Design Prompt - Xiaomi MiMo-V2.5-Pro 1.02T-A43B

Metadata from source inventory:
- Model: Xiaomi MiMo-V2.5-Pro 1.02T-A43B
- Year: 2026
- Release date: 2026-04-22
- Lab: Xiaomi
- Size / active size: 1.02T total / 43B active
...
- Source lead: https://huggingface.co/models?search=Xiaomi+MiMo-V2.5-Pro+1.02T-A43B
...
```text
You are Claude Design. Create a standalone, downloadable HTML visualization page for Xiaomi MiMo-V2.5-Pro 1.02T-A43B.

Primary source leads to use:
- Hugging Face lookup for Xiaomi MiMo-V2.5-Pro 1.02T-A43B: https://huggingface.co/models?search=Xiaomi+MiMo-V2.5-Pro+1.02T-A43B
- Local inventory provenance: /Users/rigarg/Desktop/agents/model-atlas/oss-model-releases-2025-plus.md
...
- "Xiaomi MiMo-V2.5-Pro 1.02T-A43B" "model card"
- "Xiaomi MiMo-V2.5-Pro 1.02T-A43B" "technical report"
- "Xiaomi MiMo-V2.5-Pro 1.02T-A43B" "architecture" "config"
- "Xiaomi MiMo-V2.5-Pro 1.02T-A43B" "benchmark" "Xiaomi"

Primary-source checklist for this model:
- Official model card or repository from Xiaomi.
- Official technical report, paper, release blog, or documentation page for Xiaomi MiMo-V2.5-Pro 1.02T-A43B.
...
- Model: Xiaomi MiMo-V2.5-Pro 1.02T-A43B
- Family/vendor or lab: Xiaomi
- Release/report date: 2026-04-22
- Release year: 2026
- Parameter scale: 1.02T total
- Active parameter scale: 43B active
- License or openness: MIT
- Inventory source strength: Raschka table
- Target page title: "Xiaomi MiMo-V2.5-Pro 1.02T-A43B Architecture"
...
Goal:
Build a visual architecture atlas page that explains Xiaomi MiMo-V2.5-Pro 1.02T-A43B from input tokens or modality inputs to output behavior. The page should be accurate to verified sources, visually rich, and specific to Xiaomi MiMo-V2.5-Pro 1.02T-A43B. Do not make a generic transformer explainer.
...
- The first viewport should immediately identify Xiaomi MiMo-V2.5-Pro 1.02T-A43B and show the high-level specs from the inventory.
...
- Mirror the verified report or model-card structure for Xiaomi MiMo-V2.5-Pro 1.02T-A43B when available.
- Avoid generic statements like "uses transformer blocks" unless paired with the concrete mechanism and dimensions verified for Xiaomi MiMo-V2.5-Pro 1.02T-A43B.
```
